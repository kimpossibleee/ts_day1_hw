...
function printColor (fruit: Fruit | null):void {
    if (fruit){
...
const item1: ShopItem = {
    ...
    keywords: ["Men's", "T-Shirt", "Clothing"]
};
...
const item2: ShopItem = {
    ...
    keywords: ["Women's", "Sneakers", "Shoes", "Footwear"]
};

const item3: ShopItem = {
    id: 3,
    price: 49.99,
    description: "Unisex Baseball Cap",
    color: "Black",
    category: Category.Hats,
    keywords: ["Unisex", "Cap", "Hat", "Headwear"]
};
